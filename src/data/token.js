...
export const STATS = [
	{
		value: TOKEN.supply,
		label: "Fixed supply of $OPEN. No inflation switch."
	},
	{
		value: "1",
		label: "One token across the whole network. No child tokens."
	},
	{
		value: "9",
		label: "Providers the network routes to, capped by governance."
	},
	{
		value: "Day one",
		label: "Revenue buys $OPEN and rewards providers from launch."
	}
];
